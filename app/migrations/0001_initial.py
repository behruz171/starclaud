# Generated by Django 5.1.3 on 2025-01-15 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('youtube_link_img', models.URLField()),
                ('img', models.ImageField(upload_to='video_qollanma_images/')),
                ('role', models.CharField(choices=[('seller', 'Seller'), ('admin', 'Admin'), ('director', 'Director')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('is_convicted', models.CharField(blank=True, choices=[('yes', 'Ha'), ('no', 'Yoq')], max_length=3, null=True)),
                ('is_married', models.CharField(blank=True, choices=[('yes', 'Ha'), ('no', 'Yoq')], max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percentage', models.CharField(choices=[('25%', '25%'), ('50%', '50%'), ('75%', '75%'), ('100%', '100%')], max_length=25)),
